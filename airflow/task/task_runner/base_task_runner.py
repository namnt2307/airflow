...
class BaseTaskRunner(LoggingMixin):
    ...
    def __init__(self, local_task_job):
        ...
        if self.run_as_user and (self.run_as_user != getuser()):
            ...
            cfg_path = tmp_configuration_copy(chmod=0o666, include_env=True, include_cmds=True)
            ...
            cfg_path = tmp_configuration_copy(chmod=0o666, include_env=False, include_cmds=False)
